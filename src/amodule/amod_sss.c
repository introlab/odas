    ...
    amod_sss_obj * amod_sss_construct(const mod_sss_cfg * mod_sss_config, const msg_tracks_cfg * msg_tracks_config, const msg_spectra_cfg * msg_spectra_config, const msg_envs_cfg * msg_envs_config) {

        amod_sss_obj * obj;

        obj = (amod_sss_obj *) malloc(sizeof(amod_sss_obj));

        obj->mod_sss = mod_sss_construct(mod_sss_config, msg_tracks_config, msg_spectra_config, msg_envs_config);

        obj->in1 = (amsg_spectra_obj *) NULL;
        obj->in2 = (amsg_tracks_obj *) NULL;
        obj->out1 = (amsg_spectra_obj *) NULL;
        obj->out2 = (amsg_envs_obj *) NULL;
    ...
    void amod_sss_connect(amod_sss_obj * obj, amsg_spectra_obj * in1, amsg_tracks_obj * in2, amsg_spectra_obj * out1, amsg_envs_obj * out2) {
    ...
    void * amod_sss_thread(void * ptr) {
        ...
        while(1) {
            ...
            msg_spectra_out = amsg_spectra_empty_pop(obj->out1);
            msg_envs_out = amsg_envs_empty_pop(obj->out2);
            mod_sss_connect(obj->mod_sss, msg_spectra_in, msg_tracks_in, msg_spectra_out, msg_envs_out);
            ...
            amsg_spectra_filled_push(obj->out1, msg_spectra_out);
            amsg_envs_filled_push(obj->out2, msg_envs_out);
