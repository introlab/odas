    ...
    objects * objects_construct(const configs * cfgs, const unsigned int nMessages) {
        ...
        objs->amod_noise = (amod_noise_obj *) NULL;
        objs->acon_powers = (acon_powers_obj *) NULL;
        ...
        objs->acon_spectra_lag = (acon_spectra_obj *) NULL;
    ...
    void objects_destroy(objects * objs) {
        ...
        if (objs->amod_noise != NULL) { amod_noise_destroy(objs->amod_noise); }
        if (objs->acon_powers != NULL) { acon_powers_destroy(objs->acon_powers); }
        ...
        if (objs->acon_spectra_lag != NULL) { acon_spectra_destroy(objs->acon_spectra_lag); }
    ...
    void objects_process(objects * objs) {
        ...
        if (objs->amod_noise != NULL) { thread_start(objs->amod_noise->thread); }
        if (objs->acon_powers != NULL) { thread_start(objs->acon_powers->thread); }
        ...
        if (objs->acon_spectra_lag != NULL) { thread_start(objs->acon_spectra_lag->thread); }
        ...
        if (objs->amod_noise != NULL) { thread_join(objs->amod_noise->thread); }
        if (objs->acon_powers != NULL) { thread_join(objs->acon_powers->thread); }
        ...
        if (objs->acon_spectra_lag != NULL) { thread_join(objs->acon_spectra_lag->thread); }
