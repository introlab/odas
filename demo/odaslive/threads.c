    ...
    void threads_multiple_start(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +--------------------------------------------------+  
                ...
                thread_start(aobjs->asnk_hops_mics_raw_object->thread);
    ...
    void threads_multiple_join(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_join(aobjs->asnk_hops_mics_raw_object->thread);
    ...
    void threads_single_open(objects * objs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                snk_hops_open(objs->snk_hops_mics_raw_object);
    ...
    void threads_single_close(objects * objs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                snk_hops_close(objs->snk_hops_mics_raw_object);
        ...
        // +-----------------------------------------------------------
            ...
            // +------------------------------------------------------+  
                ...
                // +--------------------------------------------------+   
                    ...
                    begin = clock();
                    snk_hops_process(objs->snk_hops_mics_raw_object);
                    end = clock();
                    prf->snk_hops_mics_raw_prf += (float) (((double) (end-begin)) / CLOCKS_PER_SEC);
